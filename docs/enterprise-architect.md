...
- **CS-rep-initiated opt-in** and **auto-opt-in** (legally risky in the v1 deployment's jurisdiction — without explicit consent; deployment-specific posture).
