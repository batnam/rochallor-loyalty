 ...
 * (loyalty-admin-bff.yaml {@code Problem} schema). {@link BffException} carries its own status/code —
 * including 401 (missing identity parameter) / 403 (role gating) and statuses translated up from upstream services by
 * {@code UpstreamErrorHandler}; anything else maps to a generic 400.
 */
