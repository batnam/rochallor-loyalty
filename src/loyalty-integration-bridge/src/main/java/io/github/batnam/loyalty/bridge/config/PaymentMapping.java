...
/**
 * Loyalty-owned, **bank-uniform** {@code paymentType → earn_source} routing map (ADR-0025,
 * the two-level shape of ADR-0021 now owned by Loyalty). A canonical paymentType not present in
