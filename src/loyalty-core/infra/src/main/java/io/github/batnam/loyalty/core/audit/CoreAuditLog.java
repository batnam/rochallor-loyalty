...
/**
 * Tamper-evident admin-write trail (CONTEXT.md "Service Audit Log"; L3 §5). Insert-only (DB trigger +
...
public class CoreAuditLog {
    ...
    protected CoreAuditLog() {
    }

    static CoreAuditLog of(String actor, String action, String entityType, String entityId,
                           String beforeJson, String afterJson, String prevHash, String rowHash) {
        CoreAuditLog a = new CoreAuditLog();
