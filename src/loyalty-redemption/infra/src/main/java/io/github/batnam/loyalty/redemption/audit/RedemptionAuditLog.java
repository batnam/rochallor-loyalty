...
@Entity
@Immutable
@Table(name = "redemption_audit_log")
public class RedemptionAuditLog {
    ...
    protected RedemptionAuditLog() {
    }

    static RedemptionAuditLog of(String actor, String action, String entityType, String entityId,
                                 String beforeJson, String afterJson, String prevHash, String rowHash) {
        RedemptionAuditLog a = new RedemptionAuditLog();
