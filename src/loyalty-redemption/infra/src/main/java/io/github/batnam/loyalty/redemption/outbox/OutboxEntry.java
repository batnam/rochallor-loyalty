...
/**
 * Transactional-outbox staging row (L3 §4). Inserted in the same transaction as the Saga state write;
 * drained to MSK by the Outbox Relay in a separate, retryable transaction — at-least-once delivery,
