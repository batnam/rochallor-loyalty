...
/**
 * Tamper-evident admin-write trail (L3 §5; ≥7-year retention). Insert-only (DB trigger + {@code @Immutable});
 * hash-chained via {@code prevHash}/{@code rowHash} so any retroactive edit breaks the chain. Nightly WORM
 * sealing to S3 Object Lock is out of scope for this scaffold.
 */
@Entity
@Immutable
...
public class CampaignAuditLog {
    ...
    static CampaignAuditLog of(String actor, String action, String entityType, String entityId,
                               String beforeJson, String afterJson, String prevHash, String rowHash) {
        CampaignAuditLog a = new CampaignAuditLog();
