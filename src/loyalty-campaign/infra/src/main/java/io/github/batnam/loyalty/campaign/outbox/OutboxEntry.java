...
/**
 * Transactional-outbox staging row (L3 §5). Inserted in the same transaction as the Drawing state write;
 * drained to MSK by the Outbox Relay in a separate, retryable transaction — at-least-once delivery, dedup
 * downstream by eventId.
 */
@Entity
@Table(name = "outbox")
