...
/**
 * ShedLock {@link LockProvider} backed by the {@code shedlock} table in loyalty-earning RDS (L3 §3.3).
 * earning runs multi-pod, so every {@code @Scheduled} job (Cap Purge) is wrapped in
