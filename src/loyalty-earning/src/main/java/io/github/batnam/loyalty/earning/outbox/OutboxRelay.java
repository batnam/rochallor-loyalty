...
/**
 * Transactional-outbox relay (L3 §4 component 9). Two responsibilities:
 * <ul>
 *   <li>{@link #enqueue} — called <b>in the Rule Engine's transaction</b> to stage an event row.</li>
